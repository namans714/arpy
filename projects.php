    ...
    <div class="row">
      <div class="col-lg-6">
        <div class="hero-heading-area">
          ...
          <div class="btn-area1">
            <a href="./">Home <i class="fa-solid fa-angle-right"></i>  <span>Our Projects</span></a>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="800" data-aos-offset="70">
          <div class="gallery-images-area">
            ...
            <div class="content-area">
              ...
              <a href="#" class="title">Agricultural Facilities</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="900" data-aos-offset="90">
          <div class="gallery-images-area">
            <div class="img1">
              <img src="assets/img/all-images/gallery/g-img2.png" alt="">
            </div>
            <div class="content-area">
              <div class="icons">
                <a href="#"><i class="fa-solid fa-arrow-right"></i></a>
        ...
        <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="1000" data-aos-offset="110">
          <div class="gallery-images-area">
            <div class="img1">
              <img src="assets/img/all-images/gallery/g-img3.png" alt="">
            </div>
            <div class="content-area">
              <div class="icons">
                <a href="#"><i class="fa-solid fa-arrow-right"></i></a>
        ...
        <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="800" data-aos-offset="70">
          <div class="gallery-images-area">
            <div class="img1">
              <img src="assets/img/all-images/projects/project-img5.png" alt="">
            </div>
            <div class="content-area">
              <div class="icons">
                <a href="#"><i class="fa-solid fa-arrow-right"></i></a>
        ...
        <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="900" data-aos-offset="90">
          <div class="gallery-images-area">
            <div class="img1">
              <img src="assets/img/all-images/projects/project-img6.png" alt="">
            </div>
            <div class="content-area">
              <div class="icons">
                <a href="#"><i class="fa-solid fa-arrow-right"></i></a>
        ...
        <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-duration="1000" data-aos-offset="110">
          <div class="gallery-images-area">
            <div class="img1">
              <img src="assets/img/all-images/projects/project-img7.png" alt="">
            </div>
            <div class="content-area">
              <div class="icons">
                <a href="#"><i class="fa-solid fa-arrow-right"></i></a>
