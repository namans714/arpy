...
<head>
  ...
  <title>Solar Energy Solutions | ARPY Renewables – Smart & Sustainable Power</title>

  <meta name="description" content="Discover customized solar energy solutions by ARPY Renewables including residential, commercial and industrial solar systems designed for efficiency, sustainability and long-term savings.">

  <meta name="keywords" content="Solar Energy Solutions India, Residential Solar Systems, Commercial Solar Solutions, Industrial Solar Projects, Solar Power Company India, Sustainable Energy Solutions">

  <meta name="robots" content="index, follow">

  <link rel="canonical" href="https://arpyrenewables.com/solutions">

  <meta property="og:type" content="website">
  <meta property="og:title" content="Smart Solar Energy Solutions | ARPY Renewables India">
...
<body>
  ...
  <div class="inner-header-section"
    style="background-image: url(assets/img/1/28.jpg); background-position: center; background-size: cover; background-repeat: no-repeat;">
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="hero-heading-area">
            ...
            <div class="btn-area1">
              <a href="solutions.html">Home <i class="fa-solid fa-angle-right"></i> <span>Solutions</span></a>
            </div>
          </div>
        </div>
      </div>
  ...
  <!-- ON GRID SOLUTION start-->

  <!-- On-Grid Solar Section (No body/html tags) -->

  <section class="ongrid-section">

    <!-- IMAGE SIDE -->
    <div class="og-visual">
      <img src="assets/img/1/5.jpg" alt="On-grid solar system rooftop" />
      <div class="og-tag">Smart Solar Power That Cuts Your Electricity Bills.</div>
      <div class="og-tag-green">Govt Subsidy ₹30,000 – ₹78,000</div>
    </div>
    ...
    <div class="og-content">
      ...
      <div class="og-points d-none">
        <div class="og-point">
          <div class="og-point-icon">⚡</div>
          <div>
            <div class="og-point-title">Massive Bill Savings</div>
            <div class="og-point-sub">Net metering allows monthly credit adjustments and huge reductions in energy
              charges.</div>
          </div>
        </div>

        <div class="og-point">
          <div class="og-point-icon">🏷️</div>
          <div>
            <div class="og-point-title">Government Subsidy</div>
            <div class="og-point-sub">Central subsidy ₹30k–₹78k + State-level incentives (Delhi/UP additional ₹30k).
            </div>
          </div>
        </div>
        ...
        <div class="og-point">
          <div class="og-point-icon">🔧</div>
          <div>
            <div class="og-point-title">25 Years Reliability</div>
            <div class="og-point-sub">High-performance panels, inverters and long-term warranty-backed installation.
            </div>
          </div>
        </div>
      </div>

      <div class="og-cost-box">
        <strong>Typical Indicative Cost (Post Subsidy):</strong><br>
        • 3 kW — ~ ₹ 90,000 onwards<br>
        • 5 kW — ~ ₹ 2,00,000 onwards<br>
        <span style="color:var(--sub);font-size:13px">(Prices vary by city, DISCOM and component selection)</span>
      </div>

      <div class="og-btns">
        <a class="og-btn-primary" href="contact">Get a Quote</a>
        <a class="og-btn-outline" href="contact">View Subsidy Details</a>
      </div>
    </div>
  ...
  <!-- OFF-GRID SOLAR SYSTEMS start -->
  <section class="ongrid-section" id="off-grid">

    <!-- IMAGE SIDE -->
    <div class="og-visual">
      <img src="assets/img/1/5.jpg" alt="On-grid solar system rooftop" />
      <div class="og-tag">Power Anywhere, Anytime — No Grid Needed.</div>
      <div class="og-tag-green">Energy Independence for Remote and Rural Living.</div>
    </div>
  ...
  <!-- Hybrid Solar Systems start -->

  <section class="ongrid-section" id="hybrid">

    <!-- IMAGE SIDE -->
    <div class="og-visual">
      <img src="assets/img/1/11.jpg" alt="On-grid solar system rooftop" />
      <div class="og-tag">Uninterrupted Power, Day and Night.</div>
      <div class="og-tag-green">Smart Solar Energy with Built-In Backup.</div>
    </div>
    ...
    <div class="og-content">
      ...
      <div class="og-btns">
        <!-- New CTA -->
        <a href="contact" class="og-cta-full">Request Your Hybrid Solar Systems Consultation Today</a>
      </div>
    </div>
  ...
  <!-- Residential Solar Solutions start -->
  <section class="ongrid-section" id="residential">

    <!-- IMAGE SIDE -->
    <div class="og-visual">
      <img src="assets/img/1/12.jpg" alt="On-grid solar system rooftop" />
      <div class="og-tag">Clean, Affordable Power for Your Home.</div>
      <div class="og-tag-green">Smart Solar Living Made Simple.</div>
    </div>
    ...
    <div class="og-content">
      ...
      <div class="og-btns">
        <!-- New CTA -->
        <a href="contact" class="og-cta-full">Request Your Residential Solar Solutions Consultation Today</a>
      </div>
    </div>
  ...
  <!-- Housing Societies Solution start -->

  <section class="ongrid-section" id="housing">

    <!-- IMAGE SIDE -->
    <div class="og-visual">
      <img src="assets/img/1/14.jpg" alt="On-grid solar system rooftop" />
      <div class="og-tag">Shared Solar Power for Smarter Community Living.</div>
      <div class="og-tag-green">Reliable, Cost-Efficient Energy for Every Resident.</div>
    </div>
  ...
  <!-- Commercial & Industrial Solar Solutions start -->

  <section class="ongrid-section" id="ci">

    <!-- IMAGE SIDE -->
    <div class="og-visual">
      <img src="assets/img/1/16.jpg" alt="On-grid solar system rooftop" />
      <div class="og-tag">High-Performance Solar Power for Business Growth.</div>
      <div class="og-tag-green">Cut Costs, Boost Efficiency, Power Your Operations Sustainably.</div>
    </div>
    ...
    <div class="og-content">
      ...
      <div class="og-btns">
        <!-- New CTA -->
        <a href="contact" class="og-cta-full">Book Your Commercial & Industrial Solar Consultation</a>
      </div>
    </div>
